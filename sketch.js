...
function setup() {
  ...
  //btn 2 
  tesora1 = createImg('cut_btn.png');
  tesora1.position(330, 35);
  tesora1.size(50, 50);
  tesora1.mouseClicked(drop2);

  //btn 3 
  tesora2 = createImg('cut_btn.png');
  tesora2.position(360, 200);
  tesora2.size(50, 50);
  tesora2.mouseClicked(drop3);
  ...
  melaolig = new Link(corda2, fruit);
  melaolig2 = new Link(corda3, fruit);
